...
// OpenShift and Kind/integration-test Prometheus scraper identities.
const (
	OpenShiftScraperNamespace = "openshift-user-workload-monitoring"
	OpenShiftScraperSA        = "prometheus-user-workload"
	KindScraperNamespace      = "konflux-monitoring-test"
	KindScraperSA             = "prometheus"
)
...
// PrimaryScraperServiceAccount returns the Prometheus SA used to mint operand scrape tokens.
func PrimaryScraperServiceAccount(openShift bool) types.NamespacedName {
	if openShift {
		return types.NamespacedName{Namespace: OpenShiftScraperNamespace, Name: OpenShiftScraperSA}
	}
	return types.NamespacedName{Namespace: KindScraperNamespace, Name: KindScraperSA}
}
...
func EnsurePrometheusScrapeToken(ctx context.Context, in EnsureScrapeTokenInput) (time.Duration, error) {
	...
	scraper := PrimaryScraperServiceAccount(in.OpenShift)
