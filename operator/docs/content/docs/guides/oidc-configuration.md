...
against one or more upstream identity providers. The operator manages both components
...
GitHub OAuth is the most common connector for production Konflux deployments.
