...
```
To customise the operator image or Konflux CR before running, see [Script configuration](#script-configuration).
...
instead. See [Examples]({{< relref "../examples" >}}) for alternative sample
configurations.
{{< /alert >}}
