...
var _ = Describe("KonfluxCertManager Controller", func() {
	...
	Context("isNoKindMatchError helper function", func() {
		It("should correctly identify NoKindMatchError", func() {
			...
			Expect(isNoKindMatchError(noKindErr)).To(BeTrue())

			otherErr := fmt.Errorf("some other error")
			Expect(isNoKindMatchError(otherErr)).To(BeFalse())
		})
		...
		It("should return false for wrapped errors that are not NoKindMatchError", func() {
			...
			Expect(isNoKindMatchError(wrappedErr)).To(BeFalse())
		})
		...
		It("should return true for wrapped NoKindMatchError", func() {
			...
			Expect(isNoKindMatchError(wrappedErr)).To(BeTrue())
		})
	})
})
