...
// +kubebuilder:rbac:groups=rbac.authorization.k8s.io,resources=clusterroles,resourceNames=integration-service-componentgroup-admin-role;integration-service-componentgroup-editor-role;integration-service-componentgroup-viewer-role;integration-service-integrationtestscenario-admin-role;integration-service-integrationtestscenario-editor-role;integration-service-integrationtestscenario-viewer-role;integration-service-manager-role;integration-service-metrics-auth-role;integration-service-metrics-reader;integration-service-nudgeconfig-admin-role;integration-service-nudgeconfig-editor-role;integration-service-nudgeconfig-viewer-role;integration-service-snapshot-garbage-collector;integration-service-tekton-editor-role;konflux-integration-runner,verbs=bind;escalate
