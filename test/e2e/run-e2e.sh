...
# Free Kind/GHA capacity before the heavy conformance PipelineRuns (UI/Dex/NL → 0, Results off).
bash "${REPO_ROOT}/scripts/operator-e2e/quiet-cluster-for-conformance.sh" "${REPO_ROOT}"
