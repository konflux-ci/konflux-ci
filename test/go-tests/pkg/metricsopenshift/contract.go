...
// ValidateOperandScrapeResync asserts metrics-scrape-resync annotations are absent for
// component targets (annotation nudges are not part of the scrape model).
