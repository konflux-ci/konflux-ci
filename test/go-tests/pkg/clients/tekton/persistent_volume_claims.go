...
func (t *Controller) CreatePVCInAccessMode(name, namespace string, accessMode corev1.PersistentVolumeAccessMode) (*corev1.PersistentVolumeClaim, error) {
...
func (t *Controller) DeletePVC(name, namespace string) error {
	return t.KubeInterface().CoreV1().PersistentVolumeClaims(namespace).Delete(context.Background(), name, metav1.DeleteOptions{})
}

func (t *Controller) GetPVC(name, namespace string) (*corev1.PersistentVolumeClaim, error) {
