...
func (s *Controller) GetServiceAccount(saName, namespace string) (*corev1.ServiceAccount, error) {
	return s.KubeInterface().CoreV1().ServiceAccounts(namespace).Get(context.Background(), saName, metav1.GetOptions{})
}

func (s *Controller) ServiceAccountPresent(saName, namespace string) wait.ConditionFunc {
...
func (s *Controller) CreateServiceAccount(name, namespace string, serviceAccountSecretList []corev1.ObjectReference, labels map[string]string) (*corev1.ServiceAccount, error) {
...
func (h *Controller) DeleteAllServiceAccountsInASpecificNamespace(namespace string) error {
