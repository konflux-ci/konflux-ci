...
// and returns it.
func (r *Controller) GetPyxisImageByImageID(pyxisStageImagesApiEndpoint, imageID string,
...
// as a slice.
func (r *Controller) GetPyxisImageIDsFromCreatePyxisImageTaskLogs(logs map[string]string) ([]string, error) {
	var imageIDs []string
