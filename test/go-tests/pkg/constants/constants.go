...
const (
	...
	// TESTREPO_REVISION sets the revision for https://github.com/<org>/testrepo in conformance
	// (component + ITS). CI/Tekton load it from test/e2e/testrepo-revision. When unset, use main.
	TESTREPO_REVISION_ENV string = "TESTREPO_REVISION"
